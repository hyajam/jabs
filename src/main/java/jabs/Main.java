...
public class Main {
        ...
        public static void main(String[] args) throws IOException {
                 ...
                 * scenario = new BitcoinGlobalNetworkScenario("One day in the life of Bitcoin",
                 * 1,
                 * 86400, 600, 6);
                 * scenario.AddNewLogger(new
                 * BlockConfirmationLogger(Paths.get("output/bitcoin-confirmations-log.csv")));
                 ...
                 * scenario = new
                 * NormalEthereumNetworkScenario("One hour in the life of Ethereum", 1,
                 * 3600, 13.3);
                 * scenario.AddNewLogger(new BlockPropagationDelayLogger(
                 ...
                 * 40, 3600);
                 * scenario.AddNewLogger(new
                 * PBFTCSVLogger(Paths.get("output/pbft-simulation-log.csv")));
                 * scenario.run();
                 *
                 ...
                 * 3600);
                 * scenario.AddNewLogger(new
                 * SnowCSVLogger(Paths.get("output/slush-simulation-log.csv")));
                 * scenario.run();
                 */

                // Simulate Snow LAN network of 40 nodes for 1 hour
                scenario = new SlushLANScenario("One hour of a Slush lan Network", 1, 40,
                                3600);
                scenario.AddNewLogger(new SnowCSVLogger(Paths.get("output/slush-simulation-log.csv")));
                scenario.run();
        }
}