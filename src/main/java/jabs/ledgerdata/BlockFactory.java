...
public final class BlockFactory {
        public static final int ETHEREUM_BLOCK_HEADER_SIZE = 543; // A header could have variable size but mostly its
                                                                  // really close this value
        ...
        private static final long[] BITCOIN_BLOCK_SIZE_2020_BINS = {
                        196, 119880, 254789, 396047, 553826, 726752, 917631, 1021479, 1054560, 1084003, 1113136,
                        1138722, 1161695,
        ...
        public static int sampleBitcoinBlockSize(RandomnessEngine randomnessEngine) {
                return (int) randomnessEngine.sampleDistributionWithBins(BITCOIN_BLOCK_SIZE_2020,
        ...
        public static PBFTBlock samplePBFTBlock(Simulator simulator, RandomnessEngine randomnessEngine,
                        PBFTNode creator, PBFTBlock parent) {
        ...
        public static SnowBlock sampleSnowBlock(Simulator simulator, RandomnessEngine randomnessEngine,
                        SnowNode creator, SnowBlock parent) {
        ...
        public static SnowBlock sampleSlushBlock(Simulator simulator, RandomnessEngine randomnessEngine,
                        SlushNode creator, SnowBlock parent) {
                return new SnowBlock(sampleBitcoinBlockSize(randomnessEngine), parent.getHeight() + 1,
                                simulator.getSimulationTime(), creator, parent); // TODO: Size of Snow Blocks
        }

        public static EthereumBlock sampleEthereumBlock(Simulator simulator, RandomnessEngine randomnessEngine,
                ...
                return new EthereumBlock(sampleBitcoinBlockSize(randomnessEngine), parent.getHeight() + 1,
                                simulator.getSimulationTime(), creator, parent, uncles, ETHEREUM_MIN_DIFFICULTY,
                                weight); // TODO: Block Size
        }
}
