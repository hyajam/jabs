...
public class BitcoinGlobalNetworkScenario extends AbstractScenario {
    ...
    /**
     * creates a Bitcoin network scenario with parameters close to real-world but excluding
     * transaction simulation for better simulation speed
     *
    ...
    protected void createNetwork() {
        ...
        bitcoinNetwork.populateNetwork(simulator, new NakamotoConsensusConfig(this.averageBlockInterval));
    }
