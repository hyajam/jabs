...
public class DAGsperGlobalBlockchainNetwork extends EthereumGlobalBlockchainNetwork {
    ...
    public DAGsperGlobalBlockchainNetwork(int checkpointSpace) {
    ...
    public EthereumDAGsperNode createNewEthereumDAGsperNode(Simulator simulator, Network network, int nodeID, int checkpointSpace, int numOfStakeholders) {
        ...
        return new EthereumDAGsperNode(simulator, nodeID, network.sampleDownloadBandwidth(region), network.sampleUploadBandwidth(region), checkpointSpace, numOfStakeholders);
    }
    ...
    public EthereumDAGsperMiner createNewEthereumDAGsperMiner(Simulator simulator, Network network, int nodeID, int checkpointSpace, int numOfStakeholders) {
        ...
        return new EthereumDAGsperMiner(simulator, nodeID, network.sampleDownloadBandwidth(region), network.sampleUploadBandwidth(region), sampleHashPower(), checkpointSpace, numOfStakeholders);
    }
}
